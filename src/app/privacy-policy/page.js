...
const privacyPolicy = () => {
  return (
 <div className="min-h-screen bg-[#f5f5f5] flex flex-col font-apfel-grotezk-regular">
    <Header />
      ...
      <main className="flex-grow overflow-y-auto">
        <div className="container mx-auto px-4 py-10 w-full max-w-4xl">
          <h1 className="text-electric-blue font-qimnao text-3xl text-center mb-6 mt-9">
            Privacy Policy
          </h1>
          ...
          <ul className="list-disc pl-6 text-gray-700 mb-6 space-y-2">
            ...
            <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Snatch Social LLP, G-1/192, Pushpa Kunj, Wadala Station Road, Wadala West, Mumbai-400031.</li>
            ...
            <li><strong>Website</strong> refers to Snatch Social, accessible from app.snatchsocial.com</li>
          ...
          <h4 className="text-lg font-semibold text-gray-800 mt-4 mb-2">Information from Third-Party Social Media Services</h4>
          <p className="mb-6 text-gray-700">
          ...
          <h4 className="text-lg font-semibold text-gray-800 mt-4 mb-2">Necessary / Essential Cookies</h4>
          <p className="mb-2 text-gray-700"><strong>Type:</strong> Session Cookies</p>
          <p className="mb-2 text-gray-700"><strong>Administered by:</strong> Us</p>
          <p className="mb-6 text-gray-700">
          ...
          <h4 className="text-lg font-semibold text-gray-800 mt-4 mb-2">Cookies Policy / Notice Acceptance Cookies</h4>
          <p className="mb-2 text-gray-700"><strong>Type:</strong> Persistent Cookies</p>
          <p className="mb-2 text-gray-700"><strong>Administered by:</strong> Us</p>
          <p className="mb-6 text-gray-700">
            <strong>Purpose:</strong> These Cookies identify if users have accepted the use of cookies on the Website.
          </p>

          <h4 className="text-lg font-semibold text-gray-800 mt-4 mb-2">Functionality Cookies</h4>
          <p className="mb-2 text-gray-700"><strong>Type:</strong> Persistent Cookies</p>
          <p className="mb-2 text-gray-700"><strong>Administered by:</strong> Us</p>
          <p className="mb-6 text-gray-700">
          ...
          <h2 className="text-2xl font-semibold text-gray-800 mt-8 mb-4">Retention of Your Personal Data</h2>
          <p className="mb-6 text-gray-700">
          ...
          <h2 className="text-2xl font-semibold text-gray-800 mt-8 mb-4">Transfer of Your Personal Data</h2>
          <p className="mb-6 text-gray-700">
          ...
          <h2 className="text-2xl font-semibold text-gray-800 mt-8 mb-4">Delete Your Personal Data</h2>
          <p className="mb-6 text-gray-700">
          ...
          <h2 className="text-2xl font-semibold text-gray-800 mt-8 mb-4">Disclosure of Your Personal Data</h2>

          <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">Business Transactions</h3>
          <p className="mb-6 text-gray-700">
