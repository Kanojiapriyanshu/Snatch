...
// //   }
 ...
 // <DashboardContext.Provider value={{ isInstagramLinked }}>
    ...
    //         <div className="flex-1 mt-1 3xl:mt-2 w-[98.4%] mr-5 bg-white rounded-xl shadow relative font-qimano overflow-hidden px-4 md:px-8 xl:px-16 py-[clamp(20px,calc(8px+5vh+1vw),100px)] min-h-[250px] xl:min-h-[90px] 2xl:min-h-[200px] 5xl:min-h-[600%] flex">
    //           <div
