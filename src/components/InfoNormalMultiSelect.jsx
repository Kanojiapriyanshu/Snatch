...
const InfoNormalMultiSelect = ({ label, options, selectedValues, onAddValue, onRemoveValue }) => {
  ...
  return (
    <div ref={wrapperRef} className="relative w-full">
      ...
      {/* Input container */}
      <div
        className="relative w-full bg-transparent rounded-md border border-gray-300 p-[2px] pr-8 text-graphite outline-none transition focus:border-primary active:border-primary cursor-pointer"
